...
public class TestConfigMobileReader extends GenericTest {
	...
	public void readConfigurationMobileAndroid() {
		HashMap<String, String> config = new ConfigMobileReader().readConfig("android", "", "dev");
	...
	public void readConfigurationMobileApple() {
		HashMap<String, String> config = new ConfigMobileReader().readConfig( "ios", "", "dev");
	...
	public void verifyNoLeakBetween4_4and3_3() {
		HashMap<String, String> config = new ConfigMobileReader().readConfig( "android", "4.4", "dev");
		Assert.assertNull(config.get("special43"));
	}
	
	@Test(groups={"ut"})
	public void readHeritageInApple7() {
		HashMap<String, String> config = new ConfigMobileReader().readConfig( "ios", "ios_7", "dev");
	...
	public void readConfigMobileDifferentPage() {
		HashMap<String, String> config = new ConfigMobileReader().readConfig("", "", "firstPage");
