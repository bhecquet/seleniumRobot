...
- [Test managers](#test-managers)
  ...
  - [2 Squash TM through API](#2-squash-tm-through-api)
    ...
    - [Update test case when test succeeds](#update-test-case-when-test-succeeds)
      - [Add some steps](#add-some-steps)
        - [Initial step](#initial-step)
        - [other steps](#other-steps)
      - [Add assertions](#add-assertions)
      - [Add screen captures](#add-screen-captures)
      - [Add test description](#add-test-description)
  - [Add an other Test Manager](#add-an-other-test-manager)
