...
- [10 Use several browsers inside on test scenario](#10-use-several-browsers-inside-on-test-scenario)
- [11 Attach an existing browser inside your scenario](#11-attach-an-existing-browser-inside-your-scenario)
- [12 Use external dependencies](#12-use-external-dependencies)
- [13 Customize Selenium IDE tests](#13-customize-selenium-ide-tests)
  - [Add steps](#add-steps)
