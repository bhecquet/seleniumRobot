...
- `DwebDriverGrid=https://<cloudname>.perfectomobile.com/nexperience/perfectomobile/wd/hub` => see perfecto documentation
- `platform=<platform>` 
- `cloudApiKey=<Perfecto Token>` => can be generated by a user
