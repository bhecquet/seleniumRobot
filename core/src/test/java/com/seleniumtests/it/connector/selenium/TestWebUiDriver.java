...
public class TestWebUiDriver extends GenericTest {
    ...
    public void testMultipleBrowserCreationGridMode() {
        ...
        SeleniumTestsContextManager.getThreadContext().setNodeTags("pf20018061.itsoc.itmma.fr");
        SeleniumTestsContextManager.getThreadContext().setWebDriverGrid("http://selenium-server-dev.covea.priv:4445/wd/hub");
