...
public class TestHpAlmConnector extends GenericTest {
	...
	public void testInitWithAllParameters() {
		SeleniumTestsContextManager.getThreadContext().getConfiguration().put(HpAlmConnector.HP_ALM_SERVER_URL, "http://myServer");
		SeleniumTestsContextManager.getThreadContext().getConfiguration().put(HpAlmConnector.HP_ALM_DOMAIN, "domain");
		SeleniumTestsContextManager.getThreadContext().getConfiguration().put(HpAlmConnector.HP_ALM_PROJECT, "project");
		SeleniumTestsContextManager.getThreadContext().getConfiguration().put(HpAlmConnector.HP_ALM_USER, "user");
		SeleniumTestsContextManager.getThreadContext().getConfiguration().put(HpAlmConnector.HP_ALM_PASSWORD, "password");
