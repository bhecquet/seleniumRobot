...
public class TestSeleniumTestContext extends GenericTest {
	...
	@Test(groups = "ut")
	public void testSeleniumTestContextId(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		UUID contextId = SeleniumTestsContext.getContextId();
		Assert.assertNotNull(contextId);

		// check context ID never change
		initThreadContext(testNGCtx);
		Assert.assertEquals(SeleniumTestsContext.getContextId(), contextId);
	}
	...
	public void testSuiteLevelParam(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	 ...
	 */
	@Test(groups={"ut context"})
	public void testMultipleTestShareSameParam(final ITestContext testNGCtx) {
		testParam(testNGCtx, "variable1", "value1");
	}

	private void testParam(ITestContext testNGCtx, String variable1, String value1) {
		initThreadContext(testNGCtx);
		SeleniumTestsContext seleniumTestsCtx = SeleniumTestsContextManager.getThreadContext();
	 ...
	 */
	@Test(groups={"ut context"})
	public void testTestLevelParam(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContext seleniumTestsCtx = SeleniumTestsContextManager.getThreadContext();
	 ...
	 */
	@Test(groups={"ut context"})
	public void testUserDefinedParamOverridesEnvIni(final ITestContext testNGCtx) {
		try {
			System.setProperty("key1", "userValue");
			testParam(testNGCtx, "key1", "userValue");
		} finally {
	 ...
	 */
	@Test(groups={"ut context"})
	public void testUndefinedParam(final ITestContext testNGCtx) {
		testParam(testNGCtx, "aParam", "value1");
	}
	 ...
	 */
	@Test(groups={"ut context"})
	public void testUndefinedParamOverride(final ITestContext testNGCtx) {
		testParam(testNGCtx, "anOtherParam", "value3");
	}
	...
	public void testUserDefinedParamAddedToTestVariables(final ITestContext testNGCtx) {
		try {
			...
			testParam(testNGCtx, "myUserDefinedKey", "myUserDefinedValue");
	 ...
	 */
	@Test(groups={"ut context"})
	public void testUserDefinedParamOverridesXMLUserDefined(final ITestContext testNGCtx) {
		try {
			System.setProperty("variable1", "myUserDefinedValue");
			testParam(testNGCtx, "variable1", "myUserDefinedValue");
	 ...
	 */
	@Test(groups={"ut context"})
	public void testPlatformParsingForWindows(final ITestContext testNGCtx) {
		try {
            ...
            Assert.assertNull(seleniumTestsCtx.getMobilePlatformVersion());
		} finally {
	...
	@Test(groups={"ut context"})
	public void testPlatformParsingForOSX(final ITestContext testNGCtx) {
		try {
	...
	@Test(groups={"ut context"})
	public void testPlatformParsingForAndroid(final ITestContext testNGCtx) {
		try {
	...
	@Test(groups={"ut context"})
	public void testPlatformParsingForIOS(final ITestContext testNGCtx) {
		try {
	...
	@Test(groups={"ut context"})
	public void testPlatformParsingForIOSWithoutVersion(final ITestContext testNGCtx) {
		try {
	...
	@Test(groups="ut context")
	public void testDeviceName(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testDeviceNameNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testDeviceId(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testDeviceNameId(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testWebSessionTimeout(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testWebSessionTimeoutNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testPageLoadStrategy(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	public void testWrongPageLoadStrategy(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setPageLoadStrategy("foo");
	}
	@Test(groups="ut context")
	public void testPageLoadStrategyNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testImplicitWaitTimeout(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testImplicitWaitTimeoutNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testReplayWaitTimeout(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testReplayWaitTimeoutNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testExplicitWaitTimeout(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testExplicitWaitTimeoutNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testPageLoadTimeout(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testPageLoadTimeoutNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testStartedBy(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testStartedByNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testRunMode(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testRunModeNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	public void testRunModeKo(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setRunMode("unknown");
	}
	
	@Test(groups="ut context")
	public void testNodeTags(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setNodeTags("foo, bar");
		Assert.assertEquals(SeleniumTestsContextManager.getThreadContext().getNodeTags(), List.of("foo", "bar"));
	}
	@Test(groups="ut context")
	public void testNodeTagsEmpty(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testNodeTagsNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testWebDriverGrid(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setWebDriverGrid("http://localhost:4444/wd/hub,http://localhost:4445/wd/hub");
		Assert.assertEquals(SeleniumTestsContextManager.getThreadContext().getWebDriverGrid(), List.of("http://localhost:4444/wd/hub", "http://localhost:4445/wd/hub"));
	}
	@Test(groups="ut context", expectedExceptions=ConfigurationException.class)
	public void testWebDriverGridEmpty(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setWebDriverGrid("");
	}
	@Test(groups="ut context")
	public void testWebDriverGridNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testArchiveMode(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	 ...
	 */
	@Test(groups="ut context")
	public void testArchiveModeTrue(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	 ...
	 */
	@Test(groups="ut context")
	public void testArchiveModeFalse(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testMultipleArchiveMode(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setArchive("onSuccess,onSkip");
		Assert.assertEquals(SeleniumTestsContextManager.getThreadContext().getArchive(), List.of(ArchiveMode.ON_SUCCESS, ArchiveMode.ON_SKIP));
	}
	@Test(groups="ut context")
	public void testArchiveModeNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setArchive(null);
		Assert.assertEquals(SeleniumTestsContextManager.getThreadContext().getArchive().get(0), ArchiveMode.NEVER);
	}
	@Test(groups="ut context", expectedExceptions=ConfigurationException.class)
	public void testArchiveModeKo(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setArchive("unknown");
	}
	
	@Test(groups="ut context")
	public void testVideoCaptureModeOnSuccess(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testVideoCaptureModeOnError(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testVideoCaptureModeNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setVideoCapture(null);
		Assert.assertEquals(SeleniumTestsContextManager.getThreadContext().getVideoCapture(), VideoCaptureMode.ON_ERROR);
	}
	@Test(groups="ut context", expectedExceptions=ConfigurationException.class)
	public void testVideoCaptureModeKo(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setVideoCapture("unknown");
	}
	
	@Test(groups="ut context")
	public void testAdvancedElementSearchFalse(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testAdvancedElementSearchDom(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testAdvancedElementSearchFull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testAdvancedElementSearchNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testMaskPassword(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testMaskPasswordNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testRandomInAttachment(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	// by default, devMode is true if tests are launched from IDE
	@Test(groups="ut context")
	public void testRandomInAttachmentNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testDebugCore(final ITestContext testNGCtx) {
		try {
			initThreadContext(testNGCtx);
			SeleniumTestsContextManager.getThreadContext().setDebug("core");
			Assert.assertEquals(SeleniumTestsContextManager.getThreadContext().getDebug(), List.of(DebugMode.CORE));
		} finally {
	...
	@Test(groups="ut context")
	public void testDebugCoreAndDriver(final ITestContext testNGCtx) {
		try {
			initThreadContext(testNGCtx);
			SeleniumTestsContextManager.getThreadContext().setDebug("core,driver");
			Assert.assertEquals(SeleniumTestsContextManager.getThreadContext().getDebug(), List.of(DebugMode.CORE, DebugMode.DRIVER));
		} finally {
			SeleniumTestsContextManager.getThreadContext().setDebug(null);
		}
	}
	@Test(groups="ut context")
	public void testDebugDriver(final ITestContext testNGCtx) {
		try {
			initThreadContext(testNGCtx);
			SeleniumTestsContextManager.getThreadContext().setDebug("driver");
			Assert.assertEquals(SeleniumTestsContextManager.getThreadContext().getDebug(), List.of(DebugMode.DRIVER));
		} finally {
			SeleniumTestsContextManager.getThreadContext().setDebug(null);
		}
	}
	// by default, devMode is true if tests are launched from IDE
	@Test(groups="ut context")
	public void testDebugNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setDebug(null);
	...
	@Test(groups="ut context")
	public void testBrowserIEMode(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testBrowser(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setBrowser("chrome");
		Assert.assertEquals(SeleniumTestsContextManager.getThreadContext().getBrowser(), BrowserType.CHROME);
	}
	@Test(groups="ut context")
	public void testBrowserNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context", expectedExceptions=IllegalArgumentException.class)
	public void testBrowserKo(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setBrowser("unknown");
	}
	
	@Test(groups="ut context")
	public void testChromeProfilePath(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setBrowser("chrome");
	...
	@Test(groups="ut context")
	public void testChromeProfilePathForGrid(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context", expectedExceptions = ConfigurationException.class)
	public void testWrongChromeProfilePathForLocal(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testChromeProfilePathForLocal(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setRunMode("local");
		SeleniumTestsContextManager.getThreadContext().setBrowser("chrome");
	...
	@Test(groups="ut context")
	public void testChromeProfilePathWithOtherBrowser(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testEdgeProfilePath(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testEdgeProfilePathForGrid(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setRunMode("grid");
		SeleniumTestsContextManager.getThreadContext().setBrowser("edge");
	...
	@Test(groups="ut context", expectedExceptions = ConfigurationException.class)
	public void testWrongEdgeProfilePathForLocal(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setRunMode("local");
		SeleniumTestsContextManager.getThreadContext().setBrowser("edge");
		SeleniumTestsContextManager.getThreadContext().setEdgeUserProfilePath("/home/user/edge");
	...
	@Test(groups="ut context")
	public void testEdgeProfilePathForLocal(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setRunMode("local");
		SeleniumTestsContextManager.getThreadContext().setBrowser("edge");
	...
	@Test(groups="ut context")
	public void testEdgeProfilePathWithOtherBrowser(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setBrowser("firefox");
		SeleniumTestsContextManager.getThreadContext().setEdgeUserProfilePath("default");
	...
	@Test(groups="ut context")
	public void testFirefoxProfilePath(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setBrowser("firefox");
	...
	@Test(groups="ut context")
	public void testFirefoxProfilePathForGrid(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setRunMode("grid");
		SeleniumTestsContextManager.getThreadContext().setBrowser("firefox");
	...
	@Test(groups="ut context", expectedExceptions = ConfigurationException.class)
	public void testWrongFirefoxProfilePathForLocal(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setRunMode("local");
		SeleniumTestsContextManager.getThreadContext().setBrowser("firefox");
		SeleniumTestsContextManager.getThreadContext().setFirefoxUserProfilePath("/home/user/chrome");
	...
	@Test(groups="ut context")
	public void testFirefoxProfilePathForLocal(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setRunMode("local");
		SeleniumTestsContextManager.getThreadContext().setBrowser("firefox");
	...
	@Test(groups="ut context")
	public void testFirefoxProfilePathWithOtherBrowser(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setBrowser("chrome");
		SeleniumTestsContextManager.getThreadContext().setFirefoxUserProfilePath("default");
	...
	@Test(groups="ut context")
	public void testAssumeUntrustedCertificateIssuer(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testAssumeUntrustedCertificateIssuerNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testBetaBrowser(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testBetBrowserNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testAcceptUntrustedCertificates(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testAcceptUntrustedCertificatesNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testCaptureSnapshot(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setCaptureSnapshot(false);
        Assert.assertFalse(SeleniumTestsContextManager.getThreadContext().getCaptureSnapshot());
	}
	@Test(groups="ut context")
	public void testCaptureSnapshotNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testSnapshotScrollDelay(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testSnapshotScrollDelayNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testSnapshotTopCropping(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testSnapshotTopCroppingNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testSnapshotBottomCropping(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testSnapshotBottomCroppingNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testSoftAssertEnabled(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setSoftAssertEnabled(false);
        Assert.assertFalse(SeleniumTestsContextManager.getThreadContext().isSoftAssertEnabled());
	}
	@Test(groups="ut context")
	public void testSoftAssertEnabledNull(final ITestContext testNGCtx) {
		try {
			initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testOptimizeReports(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testOptimizeReportsNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testKeepAllResults(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testKeepAllResultsNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testDeviceList(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testDeviceListNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testApp(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testAppNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testCucumberTagsNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testCucumberTests(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testCucumberTestsNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context", expectedExceptions=ConfigurationException.class)
	public void testCucumberImplementationPackageNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testTestEnv(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testTestEnvNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testAutomationName(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testAutomationNameNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setAutomationName(null);
        Assert.assertNull(SeleniumTestsContextManager.getThreadContext().getAutomationName());
	}
	
	@Test(groups="ut context")
	public void testAppium1ServerUrl(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testAppium2ServerUrl(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context", expectedExceptions = ConfigurationException.class)
	public void testWrongAppiumServerUrl(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setAppiumServerUrl("http://appium:4123");
	}
	@Test(groups="ut context")
	public void testAppiumServerUrlNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setAppiumServerUrl(null);
        Assert.assertNull(SeleniumTestsContextManager.getThreadContext().getAppiumServerUrl());
	}
	
	@Test(groups="ut context")
	public void testAppiumCapabilities(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	public void testAppiumCapabilitiesWrongFormat(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	public void testAppiumCapabilitiesDuplicateKey(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setAppiumCapabilities("cap1=val1;cap1=val2");
		SeleniumTestsContextManager.getThreadContext().getAppiumCapabilities();
	}
	@Test(groups="ut context")
	public void testAppiumCapabilitiesNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testFullReset(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testFullResetNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testNewCommandTimeout(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testNewCommandTimeoutNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testActionDelay(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testActionDelayNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testOutputDirectoryAbsolutePath(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testOutputDirectoryRelativePath(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testOutputDirectoryFromSystem(final ITestContext testNGCtx) {
		String testngOutputDirectory = ( testNGCtx).getOutputDirectory();
		try {
	...
	@Test(groups="ut context")
	public void testOutputDirectoryNull(final ITestContext testNGCtx) {
		String testngOutputDirectory = ( testNGCtx).getOutputDirectory();
		try {
			initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testDefaultOutputDirectory(final ITestContext testNGCtx) {
		String testngOutputDirectory = ( testNGCtx).getOutputDirectory();
		try {
	...
	@Test(groups="ut context")
	public void testHeadlessMode(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testHeadlessModeNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testCapabilities(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testMultipleCapabilities(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context", expectedExceptions = ConfigurationException.class)
	public void testWrongCapabilitiesFormat(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setCapabilities("app=foo.apk,foobar");
	}
	@Test(groups="ut context")
	public void testCapabilitiesNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testManualSteps(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testManualStepsNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context", expectedExceptions=ConfigurationException.class)
	public void testCustomTestsReportsWrongPath(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context", expectedExceptions=ConfigurationException.class)
	public void testCustomTestsReportsWrongFormat(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setCustomTestReports("PERF:xml::reporter/templates/report.part.test.wrong.vm");
		SeleniumTestsContextManager.getThreadContext().getCustomTestReports();
	}
	@Test(groups="ut context")
	public void testCustomTestsReportsNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testWebDriverListener(final ITestContext testNGCtx) {
		testListeners(testNGCtx, "com.seleniumtests.ut.driver.WebDriverListener1,com.seleniumtests.ut.driver.WebDriverListener2");
	 ...
	 */
	@Test(groups="ut context", expectedExceptions = ConfigurationException.class)
	public void testMixWebDriverListener(final ITestContext testNGCtx) {
		testListeners(testNGCtx, "com.seleniumtests.ut.driver.WebDriverEventListener1,com.seleniumtests.ut.driver.WebDriverListener2");

	}

	private void testListeners(ITestContext testNGCtx, String listener) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setWebDriverListener(listener);
	}
	 ...
	 */
	@Test(groups="ut context", expectedExceptions=ConfigurationException.class)
	public void testBadWebDriverListenerClass(final ITestContext testNGCtx) {
		testListeners(testNGCtx, "com.seleniumtests.core.Filter");
	}
	@Test(groups="ut context", expectedExceptions=ConfigurationException.class)
	public void testUnknownWebDriverListenerClass(final ITestContext testNGCtx) {
		testListeners(testNGCtx, "com.seleniumtests.core.Foo");
	}
	@Test(groups="ut context")
	public void testNullWebDriverListener(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testPluginReporterClass(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		...
		Assert.assertEquals(SeleniumTestsContextManager.getThreadContext().getReporterPluginClasses().size(), 8); // 7 classes, the last 6 are internal seleniumRobot reporters
		Assert.assertEquals(SeleniumTestsContextManager.getThreadContext().getReporterPluginClasses().get(6), JUnitReporter.class);
		Assert.assertEquals(SeleniumTestsContextManager.getThreadContext().getReporterPluginClasses().get(7), TestManagerReporter.class);
	}
	@Test(groups="ut context", expectedExceptions=ConfigurationException.class)
	public void testBadPluginReporterClass(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setReporterPluginClasses("com.seleniumtests.core.Filter");
	}
	@Test(groups="ut context")
	public void testNullPluginReporterClass(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setReporterPluginClasses(null);
		Assert.assertEquals(SeleniumTestsContextManager.getThreadContext().getReporterPluginClasses().size(), 6); // the 5 classes are internal seleniumRobot reporters
	}
	
	@Test(groups="ut context")
	public void testCustomSummaryReports(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context", expectedExceptions=ConfigurationException.class)
	public void testCustomSummaryReportsWrongPath(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context", expectedExceptions=ConfigurationException.class)
	public void testCustomSummaryReportsWrongFormat(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setCustomSummaryReports("PERF:xml::reporter/templates/report.part.test.wrong.vm");
		SeleniumTestsContextManager.getThreadContext().getCustomSummaryReports();
	}
	@Test(groups="ut context")
	public void testCustomSummaryReportsNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testArchiveToFile(final ITestContext testNGCtx) throws IOException {
		initThreadContext(testNGCtx);
        ...
        Assert.assertEquals(archive.getAbsolutePath(), SeleniumTestsContextManager.getThreadContext().getArchiveToFile());
	}
	@Test(groups="ut context", expectedExceptions=ConfigurationException.class)
	public void testArchiveToTarFile(final ITestContext testNGCtx) throws IOException {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testArchiveToFileNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	 ...
	 */
	@Test(groups="ut context")
	public void testProxyFromEnvIniFile(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		Assert.assertEquals(SeleniumTestsContextManager.getThreadContext().getWebProxyType(), ProxyType.DIRECT);
	}

	@Test(groups="ut context")
	public void testProxyOverride(final ITestContext testNGCtx) {
	...
	@Test(groups="ut context")
	public void testProxyType(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	 ...
	 */
	@Test(groups="ut context")
	public void testProxyTypeNull(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testProxyAddress(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testProxyPort(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setWebProxyPort(8080);
		Assert.assertEquals((int)SeleniumTestsContextManager.getThreadContext().getWebProxyPort(), 8080);
	}
	
	@Test(groups="ut context")
	public void testProxyLogin(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testProxyPassword(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testProxyExclude(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testProxyPac(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testProxyFilledInDefaultContext(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		
		// default proxy type value get from config.ini file
		Assert.assertEquals(SeleniumTestsContextManager.getThreadContext().getWebProxyType(), ProxyType.DIRECT);
        Assert.assertNull(SeleniumTestsContextManager.getThreadContext().getWebProxyAddress());
        Assert.assertNull(SeleniumTestsContextManager.getThreadContext().getWebProxyPort());
        Assert.assertNull(SeleniumTestsContextManager.getThreadContext().getWebProxyLogin());
        Assert.assertNull(SeleniumTestsContextManager.getThreadContext().getWebProxyPassword());
        Assert.assertNull(SeleniumTestsContextManager.getThreadContext().getWebProxyExclude());
        Assert.assertNull(SeleniumTestsContextManager.getThreadContext().getWebProxyPac());
	}	
	

	@Test(groups="ut context")
	public void testGetConfigPath(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testGetDataPath(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		Assert.assertTrue(SeleniumTestsContextManager.getThreadContext().getDataPath().replace(File.separator, "/").endsWith("data/"));
	}
	@Test(groups="ut context")
	public void testGetApplicationDataPath(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testGetFeaturePath(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	public void testNewOutputFolder(final ITestContext testNGCtx) throws NoSuchMethodException, SecurityException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
		...
		List<String> keys = SeleniumTestsContext.getOutputFolderNames().keySet().stream().map(o -> o.split("@")[0]).toList();
	...
	@Test(groups="ut context")
	public void testTestTypeDesktopWeb(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testTestTypeDesktopApp(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testTestTypeDesktopAppAlreadyLaunched(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testTestTypeAndroidWebFirefox(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setApp(null); // to override parameter from exampleConfigGenericParams
	 ...
	 */
	@Test(groups="ut context")
	public void testTestTypeAndroidAppFromApk(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setPlatform("Android 10.0");
	 ...
	 */
	@Test(groups="ut context")
	public void testTestTypeAndroidInstalledApp(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setApp(null); // to override parameter from exampleConfigGenericParams
		SeleniumTestsContextManager.getThreadContext().setPlatform("Android 10.0");
		SeleniumTestsContextManager.getThreadContext().setAppPackage("com.foo.bar.app");
	...
	@Test(groups="ut context")
	public void testTestTypeIOSWebSafari(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setApp(null); // to override parameter from exampleConfigGenericParams
	 ...
	 */
	@Test(groups="ut context")
	public void testTestTypeIOSAppFromIpa(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setPlatform("iOS 12.0");
	...
	@Test(groups="ut context")
	public void testTestTypeDesktopNonGui(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testAttribute(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testAttributeNotFound(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().setAttribute("foo", "bar");
        Assert.assertNull(SeleniumTestsContextManager.getThreadContext().getAttribute("foo2"));
	}
	@Test(groups="ut context")
	public void testAttributeFoundInVariableButNotRequested(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testAttributeFoundInVariablePriority(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
	...
	@Test(groups="ut context")
	public void testAttributeFoundInVariableAndRequested(final ITestContext testNGCtx) {
		initThreadContext(testNGCtx);
		SeleniumTestsContextManager.getThreadContext().getConfiguration().put("foo2", new TestVariable("foo2", "bar2"));
		SeleniumTestsContextManager.getThreadContext().setAttribute("foo", "bar");
