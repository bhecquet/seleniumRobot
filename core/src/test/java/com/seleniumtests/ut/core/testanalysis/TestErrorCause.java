...
public class TestErrorCause extends GenericTest {
	...
	public void testNullType() {
		new ErrorCause(null, "some changes", new TestStep("step1", "step1", this.getClass(), null, new ArrayList<>(), true)).toString();
		
	}
	
	@Test(groups= {"ut"})
	public void testToString() {
		String desc = new ErrorCause(ErrorType.APPLICATION_CHANGED, "some changes", new TestStep("step1", "step1", this.getClass(), null, new ArrayList<>(), true)).toString();
		Assert.assertEquals(desc, "The application has been modified: some changes on step 'step1'");
	}
	
	@Test(groups= {"ut"})
	public void testToStringNoRootCause() {
		String desc = new ErrorCause(ErrorType.ERROR_MESSAGE, "some changes", new TestStep("step1", "step1", this.getClass(), null, new ArrayList<>(), true)).toString();
	...
	public void testToStringNoDescrition() {
		String desc = new ErrorCause(ErrorType.APPLICATION_CHANGED, null, new TestStep("step1", "step1", this.getClass(), null, new ArrayList<>(), true)).toString();
	...
	public void testToStringWithRootCauseAndDetails() {
		TestStep step = new TestStep("step1", "step1", this.getClass(), null, new ArrayList<>(), true, RootCause.DEPENDENCIES, "Error from system X", false);
		step.setFailed(true);
	...
	public void testToStringWithRootCauseNoDetails() {
		TestStep step = new TestStep("step1", "step1", this.getClass(), null, new ArrayList<>(), true, RootCause.DEPENDENCIES, "", false);
		step.setFailed(true);
		String desc = new ErrorCause(ErrorType.ERROR_MESSAGE, "some changes", step).toString();
		Assert.assertEquals(desc, "Error message displayed: some changes on step 'step1'\n"
	...
	public void testToStringWithRootCauseNoDetails2() {
		TestStep step = new TestStep("step1", "step1", this.getClass(), null, new ArrayList<>(), true, RootCause.DEPENDENCIES, null, false);
		step.setFailed(true);
		String desc = new ErrorCause(ErrorType.ERROR_MESSAGE, "some changes", step).toString();
		Assert.assertEquals(desc, "Error message displayed: some changes on step 'step1'\n"
				+ "Declared root Cause: DEPENDENCIES");
	...
	public void testToStringWithRootCauseNone() {
		TestStep step = new TestStep("step1", "step1", this.getClass(), null, new ArrayList<>(), true, RootCause.NONE, "Error from system X", false);
		step.setFailed(true);
		String desc = new ErrorCause(ErrorType.APPLICATION_CHANGED, "some changes", step).toString();
		Assert.assertEquals(desc, "The application has been modified: some changes on step 'step1'");
	}
	...
	public void testEquals() {
		ErrorCause cause1 = new ErrorCause(ErrorType.APPLICATION_CHANGED, "some changes", new TestStep("step1", "step1", this.getClass(), null, new ArrayList<>(), true));
		ErrorCause cause2 = new ErrorCause(ErrorType.APPLICATION_CHANGED, "some changes", new TestStep("step1", "step1", this.getClass(), null, new ArrayList<>(), true));
	...
	public void testEqualsDifferentStep() {
		ErrorCause cause1 = new ErrorCause(ErrorType.APPLICATION_CHANGED, "some changes", new TestStep("step1", "step1", this.getClass(), null, new ArrayList<>(), true));
		ErrorCause cause2 = new ErrorCause(ErrorType.APPLICATION_CHANGED, "some changes", new TestStep("step2", "step2", this.getClass(), null, new ArrayList<>(), true));
	...
	public void testEqualsNullStep2() {
		ErrorCause cause1 = new ErrorCause(ErrorType.APPLICATION_CHANGED, "some changes", new TestStep("step2", "step2", this.getClass(), null, new ArrayList<>(), true));
	...
	public void testEqualsDifferentDescription() {
		ErrorCause cause1 = new ErrorCause(ErrorType.APPLICATION_CHANGED, "some changes", new TestStep("step1", "step1", this.getClass(), null, new ArrayList<>(), true));
		ErrorCause cause2 = new ErrorCause(ErrorType.APPLICATION_CHANGED, "some changes2", new TestStep("step1", "step1", this.getClass(), null, new ArrayList<>(), true));
		Assert.assertNotEquals(cause1, cause2);
	}
	
	@Test(groups= {"ut"})
	public void testEqualsNullDescription1() {
		ErrorCause cause1 = new ErrorCause(ErrorType.APPLICATION_CHANGED, null, new TestStep("step1", "step1", this.getClass(), null, new ArrayList<>(), true));
		ErrorCause cause2 = new ErrorCause(ErrorType.APPLICATION_CHANGED, "some changes2", new TestStep("step1", "step1", this.getClass(), null, new ArrayList<>(), true));
		Assert.assertNotEquals(cause1, cause2);
	}
	...
	public void testEqualsNullDescription2() {
		ErrorCause cause1 = new ErrorCause(ErrorType.APPLICATION_CHANGED, "some changes", new TestStep("step1", "step1", this.getClass(), null, new ArrayList<>(), true));
		ErrorCause cause2 = new ErrorCause(ErrorType.APPLICATION_CHANGED, null, new TestStep("step1", "step1", this.getClass(), null, new ArrayList<>(), true));
		Assert.assertNotEquals(cause1, cause2);
	}
	...
	public void testEqualsDifferentType() {
		ErrorCause cause1 = new ErrorCause(ErrorType.APPLICATION_CHANGED, "some changes", new TestStep("step1", "step1", this.getClass(), null, new ArrayList<>(), true));
		ErrorCause cause2 = new ErrorCause(ErrorType.ERROR_IN_FIELD, "some changes", new TestStep("step1", "step1", this.getClass(), null, new ArrayList<>(), true));
		Assert.assertNotEquals(cause1, cause2);
	}
