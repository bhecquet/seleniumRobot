...
public class TestLogActions extends GenericDriverTest {
	...
	public void testLogPageFactorySeleniumElementActionNoOverride() throws Exception {
		...
		Assert.assertEquals(clickAction.getElement().getName(), "Decorated {<button id=\"button2\" name=\"resetButton\" onclick=\"javascript:addText('text2', '');javascript:resetState();\">}");
	}
}