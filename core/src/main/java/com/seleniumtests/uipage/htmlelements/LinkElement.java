...
public class LinkElement extends HtmlElement {
    ...
    public LinkElement(final String label, final By by, final Integer index, Integer replayTimeout) {
    ...
    public LinkElement(final String label, final By by, final HtmlElement parent, final Integer index, Integer replayTimeout) {
    ...
    public LinkElement(final String label, final By by, final FrameElement frame, final Integer index, Integer replayTimeout) {
