 ...
 *
 */
public class SeleniumHostUtility {
	
	protected static final Logger logger = SeleniumRobotLogger.getLogger(SeleniumHostUtility.class);


	/**
	 * Take screenshot of the desktop and put it in a file
	 */
	public static BufferedImage captureDesktopToBuffer() {
